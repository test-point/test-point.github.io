...
In accordance with the ausdigital [API Specification](https://app.swaggerhub.com/api/ausdigital/ausdigital-syn/1.0.0).  No authentication is required.
